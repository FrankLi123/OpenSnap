var defaultSites = {
  ...
  "Australia Nine Entertainment": {
    ...
    allow_cookies: 1,
    block_regex: /(\.piano\.io\/xbuilder\/experience\/execute|cdn\.cxense\.com\/|cdn\.ampproject\.org\/v\d\/amp-subscriptions-.+\.js)/,
    exception: [{
        domain: "afr.com",
        allow_cookies: 1,
        block_regex: /(\.afr\.com\/assets\/StandardArticleTemplate\..+\.chunk\.js|\.tinypass\.com\/)/,
        cs_dompurify: 1
      }
    ]
  },
  ...
  "De Limburger (fetch from archive.is)": {
    domain: "limburger.nl",
    allow_cookies: 1,
    block_regex: /\.limburger\.nl\/extra\/assets\/resources\/js\/zephrIntegration\.js/,
    cs_dompurify: 1
  },
  "De Tijd": {
    domain: "tijd.be",
  ...
  "Der Tagesspiegel (not background/checkpoint)": {
  ...
  "Financial News (London; fetch from archive.is)": {
    domain: "fnlondon.com",
    allow_cookies: 1,
  ...
  "Financieele Dagblad (fd.nl; fetch from archive.is)": {
    domain: "fd.nl",
    allow_cookies: 1,
  ...
  "Foreign Policy": {
    ...
    allow_cookies: 1,
    block_regex: /(\.piano\.io\/xbuilder\/experience\/execute|cdn\.cxense\.com\/)/,
    cs_dompurify: 1
  },
  "Fortune": {
    domain: "fortune.com",
  ...
  "Grupo Clarín": {
    ...
    allow_cookies: 1,
    block_regex: /\.clarin\.com\/.+\/(meter|zonda-).*\.js/,
    exception: [{
        domain: "lavoz.com.ar",
        allow_cookies: 1,
  ...
  "Inc42": {
    domain: "inc42.com",
    allow_cookies: 1,
    block_regex: /(\/inc42\.com\/wp-admin\/admin-ajax\.php$|cdn\.ampproject\.org\/v\d\/amp-access-.+\.js)/
  },
  ...
  "Libération.fr (only when in source)": {
  ...
  "LiveMint (not epaper)": {
    domain: "livemint.com",
    allow_cookies: 1,
    block_regex: /(\.livemint\.com\/lm-img\/subscription\/|\.tinypass\.com\/|cdn\.ampproject\.org\/v\d\/amp-access-.+\.js)/
  },
  ...
  "McClatchy Group (opt-in to custom sites for unlisted)": {
    ...
    block_regex: /(\.amplitude\.com\/|\.mcclatchy\.com\/mcc-paywall\.js|cdn\.ampproject\.org\/v\d\/amp-(access|subscriptions)-.+\.js)/
  },
  ...
  "Mediahuis Nederland Regional (fetch from archive.is)": {
  ...
  "MediaNews Group (opt-in to custom sites for unlisted)": {
    ...
    allow_cookies: 1,
    block_regex: /(\.com\/(script|.+\/loader\.min)\.js|\.tinypass\.com\/|cdn\.ampproject\.org\/v\d\/amp-subscriptions-.+\.js)/,
    cs_dompurify: 1
  },
  ...
  "Pirate Wires": {
    ...
    block_regex: /\.piratewires\.com\/_next\/static\/chunks\/3930-.+\.js/,
  ...
  "Seeking Alpha (use free account)": {
    domain: "seekingalpha.com",
    allow_cookies: 1,
    block_regex: /(\.tinypass\.com\/|\/seekingalpha.com\/(mpw_count|api\/.+\/service_subscriptions))/,
    cs_dompurify: 1
  },
  "Slate": {
    domain: "slate.com",
 ...
 "Sport Life Ibérica (text only; opt-in to custom sites)": {
  ...
  "Südwest Media Network (opt-in to custom sites)": {
    domain: "###_de_smn",
    group: [],
    allow_cookies: 1,
    useragent: "googlebot"
  ...
  "The Atlanta Journal-Constitution (+ Cox First Media/opt-in to custom sites)": {
    ...
    exception: [{
        domain: "ajc.com",
        allow_cookies: 1,
        block_regex: /(\.piano\.io\/xbuilder\/experience\/execute|cdn\.cxense\.com\/|\.sophi\.io\/)/
      }
    ]
  },
  "The Atlantic": {
  ...
  "The Economist (fetch from archive.is)": {
    domain: "economist.com",
    allow_cookies: 1,
    block_regex: /(\.tinypass\.com\/|\/zephr\/feature)/,
    cs_dompurify: 1
  },
  ...
  "The Irish News": {
    ...
    allow_cookies: 1,
    block_regex: /\.irishnews\.com\/arc\/subs\/p\.min\.js/
  },
  "The Irish Times": {
  ...
  "Times Higher Education": {
    ...
    allow_cookies: 1,
    block_js_inline: /\.timeshighereducation\.com\/((books|features|news|people)\/|.+((\w)+(\-)+){3,})/
  },
  "Times of India": {
  ...
  "WirtschaftsWoche (fetch from archive.is)": {
    domain: "wiwo.de",
    allow_cookies: 1,
    block_regex: /(\.piano\.io\/|\.wiwo\.de\/js\/.+\/wt\..+\.js)/,
    cs_dompurify: 1
  },
  "Wonderzine": {
  ...
  "Wyborcza.pl (fetch from archive.is)": {
    domain: "wyborcza.pl",
    allow_cookies: 1,
    cs_dompurify: 1
  },
  ...
  "Arc XP": {
    ...
    excluded_domains: ["latercera.com", "nzherald.co.nz"]
  },
  "Axate.io": {
    domain: "###_uk_axate.io",
    allow_cookies: 1,
...
var custom_flex_not = {
  ...
  "###_wp_leaky_paywall": ["epsilontheory.com", "fitsnews.com", "heisenbergreport.com", "investmentnews.com", "thewirechina.com", "toolkits.com", "uppereastsite.com"],
...
var custom_flex_nofix_domains = [].concat(custom_flex_not['###_wp_leaky_paywall'], custom_flex_not['###_uk_axate.io']);
...
var de_funke_medien_nofix_domains = ['harzkurier.de'];
var de_smn_nofix_domains = ['schwarzwaelder-bote.de', 'stuttgarter-nachrichten.de', 'stuttgarter-zeitung.de'];
...
var se_bonnier_group_nofix_domains = ['di.se', 'dn.se', 'expressen.se', 'hd.se', 'sydsvenskan.se'];
var nofix_sites = ['11freunde.de', 'abplive.com', 'aftenposten.no', 'aftonbladet.se', 'al-monitor.com', 'allgaeuer-zeitung.de', 'americanscientist.org', 'arkansasonline.com', 'asahi.com', 'asiatimes.com', 'aviationweek.com', 'badische-zeitung.de', 'bhaskar.com', 'bisnis.com', 'bloomberglaw.com', 'bloombergtax.com', 'bnef.com', 'borsen.dk', 'businessdesk.co.nz', 'businessinsider.de', 'businessinsider.jp', 'businesslive.co.za', 'businesstimes.com.sg', 'caixin.com', 'caixinglobal.com', 'capital.de', 'caravanmagazine.in', 'catalyst-journal.com', 'chegg.com', 'consumerreports.org', 'costar.com', 'coursehero.com', 'dealstreetasia.com', 'delfi.ee', 'denikn.cz', 'deutsche-wirtschafts-nachrichten.de', 'die-glocke.de', 'diepresse.com', 'donaukurier.de', 'elordenmundial.com', 'endpts.com', 'entrepreneur.com', 'epw.in', 'ewmagazine.nl', 'falter.at', 'finance.si', 'franc-tireur.fr', 'freiepresse.de', 'ftchinese.com', 'ftchineselive.com', 'gamestar.de', 'gazetaprawna.pl', 'gazeteoksijen.com', 'geo.de', 'gp.se', 'handelsblatt.com', 'hbrarabic.com', 'hbrchina.org', 'hbrfrance.fr', 'hedgehogreview.com', 'hindutamil.in', 'history.org.uk', 'ifre.com', 'ilmanifesto.it', 'ilsecoloxix.it', 'information.dk', 'investors.com', 'iltalehti.fi', 'investing.com', 'jacobin.com', 'janes.com', 'jungefreiheit.de', 'kicker.de', 'kleinezeitung.at', 'kommunen.dk', 'krone.at', 'laverita.info', 'lavie.fr', 'lavozdegalicia.es', 'law360.ca', 'law360.co.uk', 'law360.com', 'leconomiste.com', 'ledesk.ma', 'lefigaro.fr', 'lefilmfrancais.com', 'lemonde.fr', 'lequipe.fr', 'lesjours.fr', 'letemps.ch', 'libertiesjournal.com', 'lindipendente.online', 'lr-online.de', 'mailplus.co.uk', 'main-echo.de', 'mainpost.de', 'malaysiakini.com', 'marianne.net', 'maville.com', 'mediapart.fr', 'milanofinanza.it', 'mittelbayerische.de', 'money.it', 'moneycontrol.com', 'moodys.com', 'morningstar.com', 'motorsport.com', 'moz.de', 'nachrichten.at', 'naiz.eus', 'nationaljournal.com', 'nature.com', 'nbr.co.nz', 'news24.com', 'newspapers.com', 'newsroom.co.nz', 'nikkei.com', 'nn.de', 'nouvelobs.com', 'noz.de', 'ntnews.com.au', 'nypost.com', 'ojogo.pt', 'on3.com', 'onetz.de', 'ouest-france.fr', 'pagina12.com.ar', 'penews.com', 'philonomist.com', 'pnp.de', 'politicopro.com', 'politiken.dk', 'postimees.ee', 'pressreader.com', 'publico.pt', 'rbc.ru', 'reforma.com', 'repubblica.it', 'republic.ru', 'rheinpfalz.de', 'risk.net', 'rnz.de', 'saechsische.de', 'saltwire.com', 'sciencedirect.com', 'shz.de', 'springer.com', 'statnews.com', 'stimme.de', 'streetinsider.com', 'studocu.com', 'substack.com', 'svd.se', 'swp.de', 'taxation.co.uk', 'taxjournal.com', 'telerama.fr', 'the-ken.com', 'thebanker.com', 'theinformation.com', 'theinitium.com', 'thejakartapost.com', 'themorningcontext.com', 'theparisreview.org', 'thestar.com.my', 'timeslive.co.za', 'udn.com', 'usine-digitale.fr', 'vedomosti.ru', 'vi.nl', 'volksstimme.de', 'weltwoche.ch', 'weltwoche.de', 'wissenschaft.de', 'worldpoliticsreview.com', 'woz.ch', 'wpolityce.pl', 'wz.de', 'xakep.ru', 'zaobao.com.sg'].concat(custom_flex_nofix_domains, de_funke_medien_nofix_domains, de_smn_nofix_domains, de_westfalen_medien_nofix_domains, fi_sanoma_nofix_domains, fr_be_groupe_rossel_nofix_domains, fr_groupe_ebra_nofix_domains, fr_indigo_nofix_domains, fr_jamg_nofix_domains, fr_monde_diplo_nofix_domains, it_gedi_nofix_domains, se_bonnier_group_nofix_domains);
